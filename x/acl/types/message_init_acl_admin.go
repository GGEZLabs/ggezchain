...
var _ sdk.Msg = &MsgInitAclAdmin{}

func NewMsgInitAclAdmin(creator string, admins []string) *MsgInitAclAdmin {
	return &MsgInitAclAdmin{
		Creator: creator,
		Admins:  admins,
	}
}

func (msg *MsgInitAclAdmin) ValidateBasic() error {

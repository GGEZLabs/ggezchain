...
var _ sdk.Msg = &MsgAddAclAdmin{}

func NewMsgAddAclAdmin(creator string, admins []string) *MsgAddAclAdmin {
	return &MsgAddAclAdmin{
		Creator: creator,
		Admins:  admins,
	}
}

func (msg *MsgAddAclAdmin) ValidateBasic() error {

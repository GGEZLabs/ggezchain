...
var (
	...
	ErrAdminExist                    = sdkerrors.Register(ModuleName, 1115, "admin(s) already exist")
	ErrAllAdminDeletion              = sdkerrors.Register(ModuleName, 1116, "cannot delete all admins, at least one admin must remain")
	ErrAdminNotExist                 = sdkerrors.Register(ModuleName, 1117, "admin(s) not exist")
)

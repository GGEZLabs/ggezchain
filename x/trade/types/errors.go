...
var (
	...
	ErrTradeTicker                = sdkErrors.Register(ModuleName, 1127, "invalid trade ticker")
	ErrTradeFee                   = sdkErrors.Register(ModuleName, 1128, "invalid trade fee")
	ErrTradeNetPrice              = sdkErrors.Register(ModuleName, 1129, "invalid trade trade net price")
	ErrTradeNetValue              = sdkErrors.Register(ModuleName, 1130, "invalid trade net value")
)

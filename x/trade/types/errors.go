...
var (
	...
	// ErrInvalidCoinMintingPriceJSON = sdkErrors.Register(ModuleName, 1116, "invalid coinMinting price")
	// ErrInvalidExchangeRateJSON     = sdkErrors.Register(ModuleName, 1117, "invalid exchange rate")
	ErrInvalidBankingSystemData = sdkerrors.Register(ModuleName, 1118, "invalid banking system data")

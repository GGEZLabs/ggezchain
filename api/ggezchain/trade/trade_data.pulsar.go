...
func (x *fastReflection_TradeInfo) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "ggezchain.trade.TradeInfo.issuer":
		return x.Issuer != ""
	case "ggezchain.trade.TradeInfo.number_of_shares":
	...
	case "ggezchain.trade.TradeInfo.share_net_price":
...
func (x *fastReflection_TradeInfo) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "ggezchain.trade.TradeInfo.number_of_shares":
		panic(fmt.Errorf("field number_of_shares of message ggezchain.trade.TradeInfo is not mutable"))
	case "ggezchain.trade.TradeInfo.coin_minting_price_usd":
	...
	case "ggezchain.trade.TradeInfo.share_net_price":
		panic(fmt.Errorf("field share_net_price of message ggezchain.trade.TradeInfo is not mutable"))
	case "ggezchain.trade.TradeInfo.trade_net_value":

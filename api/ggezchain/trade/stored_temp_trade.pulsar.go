...
var (
	...
	fd_StoredTempTrade_temp_trade_index protoreflect.FieldDescriptor
...
func init() {
	...
	fd_StoredTempTrade_temp_trade_index = md_StoredTempTrade.Fields().ByName("temp_trade_index")
...
func (x *StoredTempTrade) slowProtoReflect() protoreflect.Message {
	mi := &file_ggezchain_trade_stored_temp_trade_proto_msgTypes[0]
...
func (x *fastReflection_StoredTempTrade) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.TempTradeIndex != uint64(0) {
		...
		if !f(fd_StoredTempTrade_temp_trade_index, value) {
			return
		}
	}
	if x.CreateDate != "" {
...
func (x *fastReflection_StoredTempTrade) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "ggezchain.trade.StoredTempTrade.temp_trade_index":
	...
	default:
		...
		panic(fmt.Errorf("message ggezchain.trade.StoredTempTrade does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_StoredTempTrade) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message ggezchain.trade.StoredTempTrade does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_StoredTempTrade) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "ggezchain.trade.StoredTempTrade.temp_trade_index":
		panic(fmt.Errorf("field temp_trade_index of message ggezchain.trade.StoredTempTrade is not mutable"))
	case "ggezchain.trade.StoredTempTrade.create_date":
...
func (x *fastReflection_StoredTempTrade) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in ggezchain.trade.StoredTempTrade", d.FullName()))
	}
	panic("unreachable")
}
...
func (*StoredTempTrade) Descriptor() ([]byte, []int) {
	return file_ggezchain_trade_stored_temp_trade_proto_rawDescGZIP(), []int{0}
}
...
var File_ggezchain_trade_stored_temp_trade_proto protoreflect.FileDescriptor

var file_ggezchain_trade_stored_temp_trade_proto_rawDesc = []byte{
	...
	0x68, 0x61, 0x69, 0x6e, 0x2e, 0x74, 0x72, 0x61, 0x64, 0x65, 0x22, 0x7d, 0x0a, 0x0f, 0x53, 0x74,
	...
	,
...
var (
	file_ggezchain_trade_stored_temp_trade_proto_rawDescOnce sync.Once
	file_ggezchain_trade_stored_temp_trade_proto_rawDescData = file_ggezchain_trade_stored_temp_trade_proto_rawDesc
)

func file_ggezchain_trade_stored_temp_trade_proto_rawDescGZIP() []byte {
	file_ggezchain_trade_stored_temp_trade_proto_rawDescOnce.Do(func() {
		file_ggezchain_trade_stored_temp_trade_proto_rawDescData = protoimpl.X.CompressGZIP(file_ggezchain_trade_stored_temp_trade_proto_rawDescData)
	})
...
func init() { file_ggezchain_trade_stored_temp_trade_proto_init() }
func file_ggezchain_trade_stored_temp_trade_proto_init() {
	if File_ggezchain_trade_stored_temp_trade_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_ggezchain_trade_stored_temp_trade_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_ggezchain_trade_stored_temp_trade_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_ggezchain_trade_stored_temp_trade_proto_goTypes,
		DependencyIndexes: file_ggezchain_trade_stored_temp_trade_proto_depIdxs,
		MessageInfos:      file_ggezchain_trade_stored_temp_trade_proto_msgTypes,
	}.Build()
	File_ggezchain_trade_stored_temp_trade_proto = out.File
	file_ggezchain_trade_stored_temp_trade_proto_rawDesc = nil
	file_ggezchain_trade_stored_temp_trade_proto_goTypes = nil
	file_ggezchain_trade_stored_temp_trade_proto_depIdxs = nil
}

...
var file_ggezchain_trade_tx_proto_goTypes = []interface{}{
	...
	(TradeStatus)(0),                // 7: ggezchain.trade.TradeStatus
	(ProcessType)(0),                // 8: ggezchain.trade.ProcessType
}
var file_ggezchain_trade_tx_proto_depIdxs = []int32{
	...
	7, // 1: ggezchain.trade.MsgCreateTradeResponse.status:type_name -> ggezchain.trade.TradeStatus
	8, // 2: ggezchain.trade.MsgProcessTrade.process_type:type_name -> ggezchain.trade.ProcessType
	7, // 3: ggezchain.trade.MsgProcessTradeResponse.status:type_name -> ggezchain.trade.TradeStatus
	0, // 4: ggezchain.trade.Msg.UpdateParams:input_type -> ggezchain.trade.MsgUpdateParams
	2, // 5: ggezchain.trade.Msg.CreateTrade:input_type -> ggezchain.trade.MsgCreateTrade
	4, // 6: ggezchain.trade.Msg.ProcessTrade:input_type -> ggezchain.trade.MsgProcessTrade
	1, // 7: ggezchain.trade.Msg.UpdateParams:output_type -> ggezchain.trade.MsgUpdateParamsResponse
	3, // 8: ggezchain.trade.Msg.CreateTrade:output_type -> ggezchain.trade.MsgCreateTradeResponse
	5, // 9: ggezchain.trade.Msg.ProcessTrade:output_type -> ggezchain.trade.MsgProcessTradeResponse
